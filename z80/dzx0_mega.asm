...
; "Mega" version (562 bytes, 25% faster)
; -----------------------------------------------------------------------------
; Parameters:
...
dzx0m_new_offset5:
        ...
        rr      c
        ld      (dzx0m_last_offset), bc ; preserve new offset
        ld      bc, 1
...
dzx0m_reuse3:
        ...
        pop     hl                      ; restore source
        add     a, a                    ; copy from literals or new offset?
        jp      nc, dzx0m_literals2

        jp      dzx0m_new_offset2
dzx0m_last_offset:
        dw      0
; -----------------------------------------------------------------------------
